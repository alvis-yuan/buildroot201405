...
uchar * jz_framebuffer_data_ptr;//map to /dev/fb
uchar * get_jz_framebuffer_data_ptr() {
	return jz_framebuffer_data_ptr;
}
...
bool QLinuxFbScreen::connect(const QString &displaySpec)
{
    ...
    if ((long)fbdata == -1) {
        ...
        fbdata = 0;
        jz_framebuffer_data_ptr = 0;
    } else {
        fbdata += dataoffset;
        jz_framebuffer_data_ptr = fbdata;
    }
