...
ifeq ($(BR2_PACKAGE_QT_PAN_DISPLAY),y)
qt_pan_display_patch := patch_pan_display
endif

ifeq ($(BR2_PACKAGE_QT_PAN_DISPLAY_NO_COPY),y)
qt_pan_display_patch := patch_pan_display_no_copy
endif

ifneq ($(qt_pan_display_patch),)
define QT_PATCH_PAN_DISPLAY
	patch -p1 -d $(@D) <  $(TOPDIR)/package/qt/$(qt_pan_display_patch)
endef
endif

ifeq ($(BR2_PACKAGE_QTCAMERA),y)
define QT_PATCH_QTCAMERA
	cp $(TOPDIR)/package/qt/qscreenlinuxfb_qws_wz.cpp $(@D)/src/gui/embedded/qscreenlinuxfb_qws.cpp -vfr
	cp $(TOPDIR)/package/qt/qscreenlinuxfb_qws_wz.h $(@D)/src/gui/embedded/qscreenlinuxfb_qws.h -vfr
endef
endif

ifeq ($(BR2_PACKAGE_POLY_USEQT),y)
define QT_PATCH_USEQT
	cp $(TOPDIR)/ingenic/poly/polyqt/qt/qscreenlinuxfb_qws.cpp $(@D)/src/gui/embedded/qscreenlinuxfb_qws.cpp -vfr
	cp $(TOPDIR)/ingenic/poly/polyqt/qt/qscreenlinuxfb_qws.h $(@D)/src/gui/embedded/qscreenlinuxfb_qws.h -vfr
endef
endif
