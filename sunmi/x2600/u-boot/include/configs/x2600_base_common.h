...
#if defined(CONFIG_X2670M_DDR) || defined(CONFIG_X2600M_DDR)
...
#else
#define CONFIG_ROOTFS_DEV CONFIG_FLASH_TYPE CONFIG_CLK_IGNORE_UNUSED " " "root=/dev/mtdblock_bbt_ro4"
#define CONFIG_ROOTFS_DEV_BAK CONFIG_FLASH_TYPE CONFIG_CLK_IGNORE_UNUSED " " "root=/dev/mtdblock_bbt_ro5"
#endif
...
#define ARGS_ROOTFS CONFIG_ROOTFS_INITRC" ubi.mtd=8 "CONFIG_ROOTFS_DEV" "ARG_ROOTFS_TYPE" "CONFIG_BOGOMIPS
#define ARGS_ROOTFS_BAK CONFIG_ROOTFS_INITRC" ubi.mtd=8 "CONFIG_ROOTFS_DEV_BAK" "ARG_ROOTFS_TYPE" "CONFIG_BOGOMIPS
...
#define CONFIG_SPL_OS_BOOT
    ...
    #define CONFIG_SPL_BOOTARGS_BAK  BOOTARGS_COMMON " " ARGS_ROOTFS_BAK
    #define CONFIG_SPL_OS_NAME_BAK        "kernel_bak" /* spi offset of xImage being loaded */
    #define CONFIG_SYS_SPL_ARGS_ADDR_BAK    CONFIG_SPL_BOOTARGS_BAK
    #define CONFIG_SPL_HWINFO_NAME        "hwinfo" /* spi offset of xImage being loaded */
#endif
